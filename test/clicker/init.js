    ...
    var initData = {
        ...
        workers: {
            ...
            Gemmer: {
                name: "Gemmer",
                label: "Gemmer",
                description: function () { return "In more peaceful and prosperous times, the strangest of professions arise. Every Gemmer provides you with <b>" + this.resourceGain.rubyP.base + " Ruby Progress per second</b> at the cost of <b>" + Math.abs(this.resourceGain.stoneP.base) + " Stone Progress per second</b> and <b>" + Math.abs(this.resourceGain.waterP.base) + "  Progress per second</b>."; },
                current: 0,
                free: 0,
                resourceGain: {
                    stoneP: {
        ...
        upgrades: {
            ...
            upgGemmers: {
                name: "upgGemmers",
                label: "Gemmers",
                description: function () { return "Allows you to hire <b>Gemmers</b>: these workers will generate a smaller amount of <b>Ruby Progress</b> than <b>Morgan</b> but at a lesser cost."; },
                resourceCost: {
                    diamond: {
                        base: 10
                    }
                },
                effect: function () { unlock("Gemmer", "upgGemmerwork"); },
                locked: true,
                bought: false
            },
            upgDiamondTrade: {
